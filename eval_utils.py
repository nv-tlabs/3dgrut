...
def record_train_step(info_dict, model, iteration, iteration_time, l1_loss, ssim_loss, total_loss, psnr):
    ...
    info_dict['opacity_mean'].append(model.density.mean().item())
    info_dict['opacity_std'].append(model.density.std().item())
    ...
    info_dict['pos_x_mean'].append(model.positions.mean(dim=0)[0].item())
    info_dict['pos_y_mean'].append(model.positions.mean(dim=0)[1].item())
    info_dict['pos_z_mean'].append(model.positions.mean(dim=0)[2].item())
    info_dict['pos_x_std'].append(model.positions.std(dim=0)[0].item())
    info_dict['pos_y_std'].append(model.positions.std(dim=0)[1].item())
    info_dict['pos_z_std'].append(model.positions.std(dim=0)[2].item())

    info_dict['scale_x_mean'].append(model.scale.mean(dim=0)[0].item())
    info_dict['scale_y_mean'].append(model.scale.mean(dim=0)[1].item())
    info_dict['scale_z_mean'].append(model.scale.mean(dim=0)[2].item())
    info_dict['scale_x_std'].append(model.scale.std(dim=0)[0].item())
    info_dict['scale_y_std'].append(model.scale.std(dim=0)[1].item())
    info_dict['scale_z_std'].append(model.scale.std(dim=0)[2].item())

    info_dict['rot_x_mean'].append(model.rotation.mean(dim=0)[0].item())
    info_dict['rot_y_mean'].append(model.rotation.mean(dim=0)[1].item())
    info_dict['rot_z_mean'].append(model.rotation.mean(dim=0)[2].item())
    info_dict['rot_w_mean'].append(model.rotation.mean(dim=0)[3].item())
    info_dict['rot_x_std'].append(model.rotation.std(dim=0)[0].item())
    info_dict['rot_y_std'].append(model.rotation.std(dim=0)[1].item())
    info_dict['rot_z_std'].append(model.rotation.std(dim=0)[2].item())
    info_dict['rot_w_std'].append(model.rotation.std(dim=0)[3].item())
