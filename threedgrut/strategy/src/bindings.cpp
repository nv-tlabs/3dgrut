...
// (https://github.com/nerfstudio-project/gsplat/blob/main/gsplat/cuda/csrc/Relocation.cpp),
...
std::tuple<torch::Tensor, torch::Tensor> compute_relocation_tensor(
    ...
    const torch::Tensor ratios, const torch::Tensor binoms, const int n_max) {
